---
title: "Programming Workshop 2017"
author: "Gaurav D Diwan"
...
1) Arrays/vector - numeric, factors (ie categories), characters (ie non numeric)
2) Matrix (usually numeric)
3) Table/data frame (multiple variable types)
4) Lists - lists of multiple variable types

R does not have dictionaries!

## Variable declaration in R

By using a left pointing arrow '<-'
...
### Max number problem, for and while loops

```{r max numbers, echo=TRUE}
